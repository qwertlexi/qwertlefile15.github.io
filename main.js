(function () {
  ...
  var arkCursorX  = -9999;
  var arkCursorY  = -9999;
  var ARK_REPEL_R = 160;  // repulsion radius px
  ...
  function arkLoop() {
    ...
    if (arkPhase === 'falling') {
      ...
      for (var si = 0; si < arkParticles.length; si++) {
        ...
        // ── Cursor repulsion — push particles away from finger ────
        var dy_ = baseY - cy_;
        var dx_ = baseX - cx_;
        ...
        if (d2_ < R2 && d2_ > 0.01) {
          ...
          var frac_ = 1 - d_ / R;
          var mag_  = frac_ * frac_ * R * F;
          // Push in both X and Y so particles visually scatter
          sp.offsetX += (dx_ / d_) * mag_ * 0.6;
          sp.offsetY += (dy_ / d_) * mag_;
          // Surface particles get extra upward burst
          if (sp.restDepth < AFS * 3) {
            sp.offsetY -= frac_ * 18;
          }
        }
        sp.offsetX *= 0.82;
