(function () {
  ...
  (function () {
    ...
    // Wait for all boot messages (~8s), then fade out via CSS transition, then hide
    setTimeout(function() {
      overlay.classList.add("done");         // triggers opacity fade (1.2s transition)
      setTimeout(function() {
        overlay.classList.add("hidden");     // display:none after fade completes
      }, 1300);
    }, 8800);
  })();
